/* Sample catalogue. Replace with your real pieces.
   ...
   bestseller  true to feature it in the "Best sellers" row on the shop page (optional field)
*/
const PRODUCTS = [
  { id: "F-001", name: "Nylon coach jacket", cat: "Jackets", size: "L", grade: "A", price: 1800, color: "#3e5c76", chest: 58, length: 70, note: "Snap buttons, light lining. No marks.", image: "images/F-001.jpg", sold: false, bestseller: true },
  ...
  { id: "F-005", name: "Wool cardigan", cat: "Knitwear", size: "M", grade: "A", price: 1400, color: "#7a5c4f", chest: 53, length: 62, note: "Soft, no pilling. Wooden buttons.", image: "images/F-005.jpg", sold: false, bestseller: true },
  ...
  { id: "F-010", name: "Floral midi dress", cat: "Dresses", size: "Free", grade: "A", price: 1600, color: "#a56a72", chest: 48, length: 108, note: "Elastic back. Fits S to L.", image: "images/F-010.jpg", sold: false, bestseller: true },
